...
export default function Home({navItems}) {
    return (
        <Layout>
            ...
            <div className="py-7" style={{height: '45vh'}}>
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="lg:text-center">
                        ...
                        <p className="mt-1 max-w-5xl text-2xl text-md text-black lg:mx-auto">
                            Nepal America Sociocultural Exchange Society, Inc, USA (Nepali Ghar) is a non-profit organization
                        ...
                        <button className="mt-7 mb-6 bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow">
                            See more...
                        </button>
                ...
                <div className="flex info-div bg-green-50">
